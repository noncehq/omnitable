...
export declare const getFilterComponentType: (datatype: Omnitable.FilterColumn["datatype"] | string, expression: string) => "priority" | "input" | "input_number" | "select" | "range_picker" | "date_picker";
